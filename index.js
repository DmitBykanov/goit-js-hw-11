import{a as p,S as h,i as c}from"./assets/vendor-qhGxV49-.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function r(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function l(e){if(e.ep)return;e.ep=!0;const t=r(e);fetch(e.href,t)}})();const y="https://pixabay.com/api/",L="52252669-cc5c6090dc05e341eb544e959";function b(o){return p.get(y,{params:{key:L,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0}}).then(i=>i.data)}const u=document.querySelector(".gallery"),n=document.getElementById("loader"),v=new h(".gallery a",{captionsData:"alt",captionDelay:250});function w(o){if(o.length===0)return;const i=o.map(r=>{const{webformatURL:l,largeImageURL:e,tags:t,likes:a,views:f,comments:m,downloads:g}=r;return`
    ...
    `}).join("");u.insertAdjacentHTML("beforeend",i),v.refresh()}function S(){u.innerHTML=""}function E(){n&&(n.classList.remove("visually-hidden"),n.classList.add("is-loading"))}function P(){n&&(n.classList.add("visually-hidden"),n.classList.remove("is-loading"))}const d=document.querySelector(".form"),s=d.querySelector("input");d.addEventListener("submit",q);function q(o){o.preventDefault();const i=s.value.trim();if(i===""){s.classList.add("input-error"),c.warning({title:"Warning",message:"Please enter a search term.",position:"topRight"});const r=()=>{s.classList.remove("input-error"),s.removeEventListener("focus",r)};s.addEventListener("focus",r);return}S(),E(),b(i.toLowerCase()).then(r=>{if(!r.hits||r.hits.length===0){c.error({title:"No results",message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"});return}w(r.hits)}).catch(r=>{c.error({title:"Error",message:"Something went wrong while fetching images. Please try again later.",position:"topRight"})}).finally(()=>{P(),s.value=""})}
